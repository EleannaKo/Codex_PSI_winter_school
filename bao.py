...
class BAOCosmology:
    ...
    It is basically a class that helps with theoretical distance calculations in 
    units of r_s (sound horizon at drag epoch).
    """
...
class BAOLikelihood:
    ...
    """
    Loads BAo data and computes log-likelihoods
    """
    _data_loaded = {}
    _data = {}
    ...
    def load_default_data(cls, data_dir=".", dataset="DESI"):
        ...
        For dataset 'DESI2', loads from "DESI_bao_DR2.npz".
        ...
        elif dataset.upper() == "DESI2":
            filename = f"{data_dir}/desi_bao_dr2/DESI_bao_DR2.npz"
        elif dataset.upper() == "DESI_SDSS":
            filename = f"{data_dir}/DESI_SDSS_bao_data.npz"
        else:
            raise ValueError("Invalid dataset. Use 'DESI', 'DESI2' or 'DESI_SDSS'.")
